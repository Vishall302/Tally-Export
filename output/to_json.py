...
- Custom paths:
  ``python output/to_json.py --ledgers tally_ledgers_final.xml --vouchers-dir vouchers_by_final_list --output-dir vouchers_by_final_list_json``
- Validation only (no write):
  ``python output/to_json.py --dry-run``
"""
